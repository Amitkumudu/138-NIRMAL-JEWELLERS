...
Public Class crtinsurance111
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.crtinsurance111.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrtinsurance111
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtinsurance111 = New crtinsurance111()
        rpt.Site = Me.Site
        Return rpt
    End Function
