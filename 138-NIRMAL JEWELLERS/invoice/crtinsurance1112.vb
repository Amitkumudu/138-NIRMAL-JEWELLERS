...
Public Class crtinsurance1112
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.crtinsurance1112.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrtinsurance1112
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtinsurance1112 = New crtinsurance1112()
        rpt.Site = Me.Site
        Return rpt
    End Function
