...
Public Class crtinsurance123
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.crtinsurance123.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrtinsurance123
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtinsurance123 = New crtinsurance123()
        rpt.Site = Me.Site
        Return rpt
    End Function
