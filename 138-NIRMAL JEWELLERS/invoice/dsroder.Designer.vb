...
Partial Public Class dsroder
    ...
    Partial Public Class rptsessionDataTable
        ...
        Public Overloads Function AddrptsessionRow( _
                    ...
                    ByVal wast_perc As String) As rptsessionRow
            Dim rowrptsessionRow As rptsessionRow = CType(Me.NewRow,rptsessionRow)
            Dim columnValuesArray() As Object = New Object() {key, id, slno, metal, item, beedname, gross, beeds, mc, size, purity, note, ivalue, pcs, b_pcs, b_ct, b_class, rate, rtype, mcpg, customer, d_date, staff, wastage, adv_detail, image, filepath, code, design, descp, handling, wast_perc}
    ...
    Partial Public Class rptheaderDataTable
        ...
        Private columnorder_wt_detail As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public ReadOnly Property order_wt_detailColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnorder_wt_detail
            End Get
        End Property
        ...
        Public Overloads Function AddrptheaderRow( _
                    ...
                    ByVal order_wt_detail As String,  _
                    ByVal order_paymode As String) As rptheaderRow
            Dim rowrptheaderRow As rptheaderRow = CType(Me.NewRow,rptheaderRow)
            Dim columnValuesArray() As Object = New Object() {id, customer, o_key, k_date, staff, r_footer, bus_hrs, com_addr, adv_detail, cash_adv, rate, name, paymode, ret_detail, adjustment, bill_recv, total, r_type, order_advance, adj_title, c_balance, k_time, note, discount, lessadvance, report_note, companyname, ordernote, taxamount, order_wt_detail, order_paymode}
        ...
        Friend Sub InitVars()
            ...
            Me.columnorder_wt_detail = MyBase.Columns("order_wt_detail")
        ...
        Private Sub InitClass()
            ...
            Me.columnorder_wt_detail = New Global.System.Data.DataColumn("order_wt_detail", GetType(String), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnorder_wt_detail)
    ...
    Partial Public Class rptsessionRow
        ...
        Public Property handling() As String
            Get
                Try 
                    Return CType(Me(Me.tablerptsession.handlingColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'handling' in table 'rptsession' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablerptsession.handlingColumn) = value
            End Set
        End Property
        ...
        Public Function IshandlingNull() As Boolean
            Return Me.IsNull(Me.tablerptsession.handlingColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SethandlingNull()
            Me(Me.tablerptsession.handlingColumn) = Global.System.Convert.DBNull
        End Sub
    ...
    Partial Public Class rptheaderRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Property order_wt_detail() As String
            Get
                Try 
                    Return CType(Me(Me.tablerptheader.order_wt_detailColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'order_wt_detail' in table 'rptheader' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablerptheader.order_wt_detailColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function Isorder_wt_detailNull() As Boolean
            Return Me.IsNull(Me.tablerptheader.order_wt_detailColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub Setorder_wt_detailNull()
            Me(Me.tablerptheader.order_wt_detailColumn) = Global.System.Convert.DBNull
        End Sub
